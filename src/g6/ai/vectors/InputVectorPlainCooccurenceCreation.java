...
public class InputVectorPlainCooccurenceCreation implements IVectorCreation{

	FileAdapter fileAdapter;

	public InputVectorPlainCooccurenceCreation() {
	...
	/**
	 * creating the template vectors without considering the individual terms
	 * 
	 * @param totalSelectedWords
	 * @param templateVectors
	 */
